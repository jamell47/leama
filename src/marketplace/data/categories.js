...
export const CATEGORIES = [
  ...
  { id: 'meat', name: 'Meat & Poultry', slug: 'meat', icon: Beef, color: 'var(--green-light)' },
  { id: 'livestock', name: 'Livestock & Poultry', slug: 'livestock', icon: PiggyBank, color: 'var(--green-light)' },
...
export const SUBCATEGORIES = {
  ...
  meat: ['Beef', 'Pork', 'Goat', 'Poultry', 'Rabbit', 'Processed'],
  livestock: ['Poultry', 'Pigs', 'Rabbits', 'Cattle', 'Goats'],
